...
// ACPI RSDP table
pub const RSDP_POINTER: GuestAddress = GuestAddress(0xE0000);
...
pub const MEM_32BIT_DEVICES_SIZE: u64 = 640 << 20; // Ends at 0xe800_0000
...
pub const IOAPIC_SIZE: u64 = 0x1000; // Standard 4K page

// APIC
pub const APIC_START: GuestAddress = GuestAddress(0xfee0_0000);

pub const MEM_32BIT_RESERVED_START: GuestAddress = GuestAddress(0xfec0_0000);
